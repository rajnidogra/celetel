<div class="deznav">
    <div class="deznav-scroll">
        ...
        <?php
            ...
            // print_r($this->session->userdata('permission'));die;
            $menudata = setting_menu();   
            $permission = array();
        ...
        foreach ($menudata as $value) {
                if(isset($permission[$value["permission_name"]]) && $permission[$value["permission_name"]]["read"]==1){
                $menuparentdata = setting_menu_child($value['id']); 

            if(count($menuparentdata)>0){
                $href="javascript:;";
                if(!empty($value['href'])){$href = base_url($value['href']);}
                $menu_new .= '<li><a class="has-arrow " href="'.$href.'" aria-expanded="false"><div class="menu-icon"><i class="'.$value['icon'].'"></i></div><span class="nav-text">'.$value['name'].'</span></a>';
                if(isset($menuparentdata)){
                $menu_new .= '<ul aria-expanded="false">';
                foreach ($menuparentdata as $val) {
                if(isset($permission[$val["permission_name"]]) && $permission[$val["permission_name"]]["read"]==1){
                    $menu_new .= '<li><a href="'.base_url($val['href']).'">'.$val['name'].'</a></li>';
                }
                }
                $menu_new .= '</ul>';
                ...
                // $menu_new .='<li><a class="nav-link menu-title link-nav" href="'.base_url($value['href']).'"><i class="'.$value['icon'].'"></i>&nbsp;<span>'.$value['name'].'</span></a></li>';
                $menu_new .='<li><a href="'.base_url($value['href']).'" class="" aria-expanded="false">
                    <div class="menu-icon"><i class="'.$value['icon'].'"></i></div><span class="nav-text">'.$value['name'].'</span>
                </a></li>';
            }
            }
        // }
    ...
    ?>
            <!-- <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="index_3.html">Dashboard 3</a></li>
                    <li><a href="index_4.html">Dashboard 4</a></li>
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Users Manager</a>
                        <ul aria-expanded="false">
                            ...
                            <li><a href="app_profile_1.html">Profile 1</a></li>
                            <li><a href="app_profile_2.html">Profile 2</a></li>
            ...
            <li><a href="widget_basic.html" class="" aria-expanded="false">
                <div class="menu-icon">
                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Error</a>
                        <ul aria-expanded="false">
                            ...
                            <li><a href="https://w3admin.w3itexpert.com/codeigniter/demo/error_404">Error 404</a></li>
