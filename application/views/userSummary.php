                                            ...
                                            <div class="basic-form">
                                                    <div class="row">
                                                        <div class="mb-3 col-md-3">
                                                            <select type="text" name="user_id" id="user_id" class="form-control" onchange="getdata()">
                                                                <option value="">Select User Type</option>
                                                                <?php foreach ($userType as $type ) { ?>
                                                                    <option value="<?php echo $type['user_chain']; ?>"><?php echo $type["name"]; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('summary/get_summary_user_data'); ?>",
                    type: 'POST',
                    data: { todate, fromdate, user_id }
                },
                dom: 'lfBrtip',
                buttons: [
