                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="card-header flex-wrap">
                                                <div>
                                                    <h4 class="card-title">Template Id Registration</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <form action="<?php echo base_url('templatereg/save'); ?>" method="POST" enctype="multipart/form-data">
                                                    <div class="basic-form">
                                                            <div class="row">
                                                                <div class="mb-3 col-md-3">
                                                                    <label class="form-label" for="user_id">Select User</label>
                                                                    <select class="form-control" id="user_id" name="user_id" onchange="getSenderList();">
                                                                        <option value="">Select User</option>
                                                                        <?php foreach ($userList as $type) { ?>
                                                                            <option value="<?php echo $type['id']; ?>" <?php if (isset($contentData["user_id"]) && $contentData["user_id"] == $type['name']) {
        echo "selected";
                                                                ...
                                                                <div class="mb-3 col-md-3 manualDiv">
                                                                   ...
                                                                   <!--  <input type="text" class="form-control" name="sender_id[]" multiple id="sender_id" required="required" value='<?php if (isset($contentData["sender_id"])) {
                                                                        echo $contentData["sender_id"];
                                                                    } ?>'> -->
                                                <select class="form-control" id="sender" name="sender_id[]" multiple>
                                                    <option value="">Select Sender</option>
                                                </select>
                                                                </div>
                                                                <div class="mb-3 col-md-3 manualDiv">
                                                                    <label class="form-label" for="template">Template</label>
                                                                    <input type="text" class="form-control" name="template" id="template" required="required" value='<?php if (isset($contentData["template"])) {
    echo $contentData["template"];
} ?>'>
                                                                </div>
                                                                <div class="mb-3 col-md-3 manualDiv">
                                                                    <label class="form-label" for="contentid">Template Id</label>
                                                                    <input type="text" class="form-control" name="contentid" id="contentid" required="required" value='<?php if (isset($contentData["contentid"])) {
    echo $contentData["contentid"];
} ?>'>
                                                                </div>
                                                                <div class="mb-3 col-md-3 manualDiv">
                                                                    <label class="form-label" for="tmid">TMID</label>
                                                                    <input type="text" class="form-control" name="tmid" id="tmid" required="required" value='<?php if (isset($contentData["tmid"])) {
    echo $contentData["tmid"];
} ?>'>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="mb-3 col-md-3">
                                                                        <input type="hidden" name="eid" id="eid" value='<?php if (isset($contentData["id"])) {
    echo $contentData["id"];
} ?>'>
    ...
    ***********************************-->
    ...
    <script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                "ajax": {
                    url : '<?php echo base_url("templatereg/get_group_tables") ?>',
                    type : 'POST',
        ...
        $.ajax({  
                url: "<?php echo base_url("templatereg/getSenderIdList") ?>",
                method:'POST',
                data:{user_id}
            }).done(function(data) { 
                $('#sender').html(data);
