									...
									<div class="row">
										...
										<div class="col-xl-12">
                                            ...
                                            <div class="card-header flex-wrap">
                                                <div>
                                                    <h4 class="card-title">SMSC Header List</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                            <div class="basic-form">
                                                    <div class="row">
                                                        ...
                                                        <select class="form-control" name="headercode" onchange ="getdata()" id="headercode">
                                                            <?php echo $headercode;?>
                                                        </select>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('summary/headerReportingData'); ?>",
                    type: 'POST',
                    data: { todate, fromdate, account, headercode }
                },
                dom: 'lfBrtip',
                buttons: [
