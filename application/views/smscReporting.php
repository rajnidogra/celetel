										...
										<div class="col-xl-12">
                                            ...
                                            <div class="basic-form">
                                                    <div class="row">
                                                        ...
                                                        <select class="form-control" name="smsccode" onchange ="getdata()" id="smsccode">
                                                             <?php echo $smscData;?>
                                                        </select>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('summary/smscSummaryReporting'); ?>",
                    type: 'POST',
                    data: { todate, fromdate, account, smsccode }
                },
                dom: 'lfBrtip',
                buttons: [
