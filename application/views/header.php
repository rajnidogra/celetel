						...
						<div class="header-profile2">
							<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
								<div class="header-info2 d-flex align-items-center">
									<div class="header-media">
										<img src="assets/images/user.jpg" class="avatar avatar-lg" alt="">
									</div>
									<div class="header-info">
										<h6><?php echo ucfirst(strtolower($userData["name"]));?></h6>
										<?php if($this->session->userdata('isAdmin')==0){?>
											<p>Credit: <?php 
											$key = $this->session->userdata('userChain').":credit";
											echo $this->redis->HGET("smpp_user", strtolower($key));
											?></p>
									<?php }?>
									</div>
							...
							<div class=" profile-box">
								...
								<div class="account-setting">
									<!-- <a href="app_profile_2.html" class="ai-icon">
									...
									<a href="app_profile_1.html" class="ai-icon ">
										<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<a href="<?php echo base_url('login/logout');?>" class="ai-icon">
										<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
