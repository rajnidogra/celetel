									...
									<div class="row">
										...
										<div class="col-xl-12">
                                            ...
                                            <div class="card-header flex-wrap">
                                                <div>
                                                    <h4 class="card-title">SMSC Latency List</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                            <div class="basic-form">
                                                    <div class="row">
                                                        ...
                                                        <select class="form-control" name="latency" onchange ="getdata()" id="latency">
                                                             <?php echo $latencycode;?>
                                                        </select>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('summary/latancyReportingData'); ?>",
                    type: 'POST',
                    data: { todate, fromdate, account, latency }
                },
                dom: 'lfBrtip',
                buttons: [
