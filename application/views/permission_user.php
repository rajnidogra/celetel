									...
									<div class="row">
										...
										<div class="col-xl-12">
											<div class="card dz-card" id="accordion-one">
                                                ...
                                                <form action="<?php echo base_url('permissionuser/saveData');?>" method="POST">
                                                    <div class="card-body">
                                                        <div class="basic-form">
                                                                <div class="row">
                                                                    <div class="mb-3 col-md-3">
                                                                    <select class="form-control" id="user_type" name="user_type" onchange="getUserList()">
    ...
    ***********************************-->
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                "ajax": {
                    url: "<?php echo site_url('permissionuser/get_tables'); ?>",
                    type : 'POST',
