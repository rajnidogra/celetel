									...
									<div class="row">
										...
										<div class="col-xl-12">
                                            ...
                                            <div class="card-header flex-wrap">
                                                <div>
                                                    <h4 class="card-title">SMSC Traffic List</h4>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                            <div class="basic-form">
                                                    <div class="row">
                                                        ...
                                                        <select class="form-control" name="traffic" onchange ="getdata()" id="traffic">
                                                            <?php echo $traffic;?>
                                                        </select>
                                                        </div>
                                                        <div class="mb-3 col-md-3">
	...
	<script>
        ...
        function getdata(){
            ...
            $('#example').DataTable({
                ...
                "ajax": {
                    url: "<?php echo site_url('summary/trafficReportingData'); ?>",
                    type: 'POST',
                    data: { todate, fromdate, account, traffic }
                },
                dom: 'lfBrtip',
                buttons: [
